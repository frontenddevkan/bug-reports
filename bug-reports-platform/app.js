...
function initBgChargeCanvas() {
    ...
    // Сетка мельче примерно в 2 раза; увеличиваем шаги примерно на +4px
    // (было [6,6,8,6,4,6,8,6] -> стало [10,10,12,10,8,10,12,10])
    const SPACING_PATTERN = [10, 10, 12, 10, 8, 10, 12, 10];
